...
THREE.STLLoader.prototype = {
  ...
  load: function load(url, onLoad, onProgress, onError, onParseStart, onParseEnd) {
  ...
  parseBinary: function parseBinary(stl) {
    ...
    for (var i = 0; i < triangles; i++) {
      ...
      var normal = new THREE.Vector3(dv.getFloat32(offset, isLittleEndian), dv.getFloat32(offset + 4, isLittleEndian), dv.getFloat32(offset + 8, isLittleEndian));
      offset += 12;

      // Get all 3 vertices for this triangle
      for (var j = 0; j < 3; j++) {
        geometry.vertices.push(new THREE.Vector3(dv.getFloat32(offset, isLittleEndian), dv.getFloat32(offset + 4, isLittleEndian), dv.getFloat32(offset + 8, isLittleEndian)));
        offset += 12;
      }
